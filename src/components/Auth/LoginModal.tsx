								...
								<form className='space-y-6' action='#' method='POST'>
									...
									<div className='flex flex-col md:flex-row md:items-center justify-between'>
										...
										<div className='text-sm leading-6'>
											<a
												href='#'
												className='font-semibold text-myOrange hover:text-third'
											>
												Forgot password?
											</a>
										</div>
									...
									<div>
										<button
											type='submit'
											className='w-full inline-flex py-2 px-5 bg-myOrange rounded-lg justify-center items-center gap-2.5 text-base text-black font-oswald tracking-wider hover:bg-third hover:text-white transition duration-300 ease-in-out'
										>
											Sign in
										</button>
									</div>
