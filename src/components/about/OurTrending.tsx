...
const OurTrending = () => {
	return (
		<div className='bg-primary relative'>
			...
			<div className='max-w-8xl mx-auto flex flex-col lg:flex-row items-center justify-around gap-12 px-4 py-4 lg:py-12'>
				...
				<div className='lg:w-2/3 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4'>
					<div className='bg-black w-64 lg:w-48 xl:w-64 h-96 relative rounded-xl'>
					...
					<div className='bg-black w-64 lg:w-48 xl:w-64 h-96 relative rounded-xl'>
						<div className='absolute top-0 left-0 right-0 bottom-0 m-auto bg-black w-full h-full rounded-xl z-50 opacity-50'></div>
						<Image
